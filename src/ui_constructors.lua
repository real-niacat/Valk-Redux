        ...
        nodes = {
            {
                ...
                config = { align = "cl", minw = args.w, r = 0.1, min_h = args.h, colour = G.C.BLACK, emboss = 0.05, refresh_movement = true, update_func = "update_bar" },
                nodes = {
...
--         local rt = c.config.ref_table
--         rt.ref_table[rt.ref_value] = math.min(rt.max,
